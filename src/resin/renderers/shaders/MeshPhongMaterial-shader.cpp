void MeshPhongMaterial::initUniforms(UniformMap& um) {
    um = {
        ...
        { "bumpMap", newUniform<'t'>() },
        { "bumpScale", newUniform<'f'>(1.0f) },
        { "normalMap", newUniform<'t'>() },
        { "normalScale", newUniform<'v2'>(Vector2(1.0f, 1.0f)) },
        ...
        { "specular", newUniform<'c'>(Color(0x111111)) },
        { "shininess", newUniform<'f'>(30.0f) },
        { "wrapRGB", newUniform<'v3'>(Vector3(1.0f, 1.0f, 1.0f)) },
    };
}

const std::string MeshPhongMaterial::kVertexShader = 
"#define PHONG\n"
...
const std::string MeshPhongMaterial::kFragmentShader = 

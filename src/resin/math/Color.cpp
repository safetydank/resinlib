...
Color::Color(const std::string& style)
{
    // set(style);
}

Color& Color::set( const Color& value )
{
    copy(value);
    return *this;
}

Color& Color::set( uint32_t value )
{
    setHex(value);
    return *this;
}

Color& Color::set( const std::string& value )
{
    setStyle(value);
    return *this;
}

Color& Color::setHex( uint32_t hex )
{
    r = ( hex >> 16 & 255 ) / 255.0f;
    g = ( hex >> 8 & 255 ) / 255.0f;
    b = ( hex & 255 ) / 255.0f;
